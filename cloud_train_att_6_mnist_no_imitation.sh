#!/bin/bash
python3 ./code/run_attain_v6_mnist.py --train --NUM_EPOCHS 10000 --BATCH_SIZE 100 --EVAL_FREQUENCY 400 --VALID_FREQUENCY 4\
    --GPU_INDEX 2\
    --IS_TARGETED_ATTACK=True --TARGETED_LABEL 8\
    --USE_IMITATION=False\
    --DATA_DIR ../mnist --ADV_PATH_PREFIX fgsm_t8\
    --AE_TYPE ATTAE --AE_PATH ./models/AE_TGT_NO_IMIT\
    --ATT_TYPE TRAD\
