#!/bin/bash
python3 ./code/run_attain_v5_mnist.py --NUM_EPOCHS 1 --BATCH_SIZE 200 --EVAL_FREQUENCY 100\
    --DATA_DIR ../mnist \
    --AE_TYPE ATTAE\
    --ATT_TYPE TRAD\
    --load_AE=True \
    ...
    --BOUND_CHANGE_TYPE EXP --PIXEL_BOUND 0.288 --BOUND_CHANGE_RATE -0.02 --BOUND_CHANGE_EPOCHS 4\
