...
python3 ./code/run_attain_v6_mnist.py --train --NUM_EPOCHS 100000 --BATCH_SIZE 400 --EVAL_FREQUENCY 100 --VALID_FREQUENCY 4\
    --GPU_INDEX 2\
    --IS_TARGETED_ATTACK=False --USE_IMITATION=False\
    --DATA_DIR ../mnist --ADV_PATH_PREFIX fgsm\
    --AE_TYPE ATTAE --AE_PATH ./models/AE_UNTGT_NO_IMIT\
    --ATT_TYPE TRAD\
    --load_AE=True --AE_CKPT_RESTORE_NAME deep_cae.Linf0.239691.Lx3.203433.acc0.014333.ckpt\
    --INIT_MIN_VALID_ACC 0.02\
    --train_label=False \
    --ADD_RANDOM=True \
    --USE_LABEL_MASK=True \
    ...
    --BOUND_CHANGE_TYPE EXP --PIXEL_BOUND 0.2397 --BOUND_CHANGE_RATE -0.02 --BOUND_CHANGE_EPOCHS 8\
    --MIN_BOUND 0.001 --MAX_BOUND 1.0\
    --ROLL_BACK_THRESHOLD 2\
    --ABS_DIFF_THRESHOLD 1e-4\
    --ADAPTIVE_UP_THRESHOLD 1e-3 --ADAPTIVE_LOW_THRESHOLD 2e-4\
