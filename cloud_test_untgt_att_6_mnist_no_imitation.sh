...
python3 ./code/run_attain_v6_mnist.py --NUM_EPOCHS 1 --BATCH_SIZE 400 --EVAL_FREQUENCY 100 --VALID_FREQUENCY 4\
    ...
    --ATT_TYPE TRAD\
    --load_AE=True --AE_CKPT_RESTORE_NAME deep_cae.Linf0.202014.Lx4.135455.acc0.071667.ckpt\
    --INIT_MIN_VALID_ACC 0.08\
    --train_label=False \
    --ADD_RANDOM=True \
    --USE_LABEL_MASK=True \
    ...
    --BOUND_CHANGE_TYPE EXP --PIXEL_BOUND 0.202 --BOUND_CHANGE_RATE -0.02 --BOUND_CHANGE_EPOCHS 8\
