...
python3 ./code/run_attain_v6_tiny.py --NUM_EPOCHS 1 --BATCH_SIZE 80 --EVAL_FREQUENCY 50\
    ...
    --ATT_TYPE TRAD\
    --load_AE=True --AE_CKPT_RESTORE_NAME deep_cae.Linf0.126859.Lx9.027854.acc0.926815.ckpt\
    --INIT_MAX_VALID_ACC 0.9\
    --train_label=False\
    --ADD_RANDOM=True \
    --USE_LABEL_MASK=True \
    ...
    --BOUND_CHANGE_TYPE EXP --PIXEL_BOUND 0.1269 --BOUND_CHANGE_RATE -0.02 --BOUND_CHANGE_EPOCHS 4\
    --MIN_BOUND 0.001 --MAX_BOUND 0.5\
