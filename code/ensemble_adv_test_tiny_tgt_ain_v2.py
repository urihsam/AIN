...
with tf.Session(config=config, graph=g) as sess:
    ...
    model.tf_load(sess, "./models/ens_adv_train", name='tiny_cnn_ensemble_tgt_ain.ckpt', scope="ens_adv_train_target")
    ...
    with open("Ensemble_test_tiny_tgt_ain.txt", "a+") as file: 
