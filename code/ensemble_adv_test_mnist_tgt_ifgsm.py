...
with tf.Session(config=config, graph=g) as sess:
    ...
    model.tf_load(sess, "./models/ens_adv_train", "ens_adv_train_target", name='mnist_cnn_ensemble_ifgsm.ckpt')
    ...
    with open("Ensemble_test_mnist_tgt_ifgsm.txt", "a+") as file: 
