...
python3 ./code/run_attain_v6_tiny.py --train --NUM_EPOCHS 2000 --BATCH_SIZE 80 --EVAL_FREQUENCY 50\
    ...
    --ATT_TYPE TRAD\
    --load_AE=False --INIT_MAX_VALID_ACC 0.95\
    --train_label=False \
    --ADD_RANDOM=True \
    --USE_LABEL_MASK=True \
    ...
    --BOUND_CHANGE_TYPE EXP --PIXEL_BOUND 0.28 --BOUND_CHANGE_RATE -0.02 --BOUND_CHANGE_EPOCHS 2\
    --MIN_BOUND 0.001 --MAX_BOUND 0.5\
    --ROLL_BACK_THRESHOLD 5\
    --ABS_DIFF_THRESHOLD 1e-4\
    --ADAPTIVE_UP_THRESHOLD 2e-4 --ADAPTIVE_LOW_THRESHOLD 2e-5\
