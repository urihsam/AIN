...
python ./code/run_attain_v6_tiny.py --train --NUM_EPOCHS 20000 --BATCH_SIZE 80 --EVAL_FREQUENCY 50\
    ...
    --ATT_TYPE TRAD\
    --load_AE=True --AE_CKPT_RESTORE_NAME deep_cae.Linf0.163216.Lx16.258818.acc0.000000.ckpt\
    --INIT_MIN_VALID_ACC 0.0\
    --train_label=False \
    --ADD_RANDOM=True \
    --USE_LABEL_MASK=True \
    ...
    --BOUND_CHANGE_TYPE EXP --PIXEL_BOUND 0.1632 --BOUND_CHANGE_RATE -0.02 --BOUND_CHANGE_EPOCHS 4\
